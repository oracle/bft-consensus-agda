...
%format >=         = "\HSSym{\mathrel{\geq}} "
%format `elem`     = "\HSSym{\mathbin{\in}} "
%format `notElem`  = "\HSSym{\mathbin{\notin}} "
%format &&         = "\HSSym{\mathrel{\wedge}}"
%format ||         = "\HSSym{\mathrel{\vee}}"
%format >>         = "\HSSym{\mathrel{\sequ}} "
%format >>=        = "\HSSym{\mathrel{\bind}} "
%format =<<        = "\HSSym{\mathrel{\rbind}} "
%format $          = "\HSSym{\mathbin{\$}}"
