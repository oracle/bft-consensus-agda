...
isValidProposalM b = do
  -- IMPL-DIFF: In the propotype, this is
  -- > maybeS (b ^∙ bAuthor) (pure false) (λ a → isValidProposerM a (b ^∙ bRound))
  -- It is rewritten here so that the obligations generated by `RWST-weakestPre`
  -- are easier to understand.
  caseMM (b ^∙ bAuthor) of λ where
    nothing  → pure false
    (just a) → isValidProposerM a (b ^∙ bRound)
